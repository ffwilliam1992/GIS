-- Function: taxi.get_trip_vertices(bigint)

-- DROP FUNCTION taxi.get_trip_vertices(bigint);

CREATE OR REPLACE FUNCTION taxi.get_trip_vertices(v_trip_id bigint)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION taxi.get_trip_vertices(bigint)
  OWNER TO tx;
